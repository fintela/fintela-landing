...
The Company has adopted reasonable administrative, technical, and physical security measures to protect the Data Subject's personal data against damage, loss, alteration, destruction, or unauthorized use, access, or processing.

---

## Fifth. Data Subject Rights and Exercise Procedure
...
## Sixth. Data Retention

Personal data will be retained according to the following periods, depending on the category of data concerned:

(a) Identification and account data: for as long as the Data Subject's account remains active and, additionally, for 5 (five) years following its cancellation, for purposes of handling claims and authority requests;

(b) Order logs, trading instructions, and reconciliations: 10 (ten) years, in accordance with the minimum retention period for commercial books and records set out in Article 49 of the Commercial Code and applicable tax legislation;

(c) Technical audit and security logs: 2 (two) years, unless an ongoing investigation warrants a longer period; and

(d) Data processed for marketing purposes: until the Data Subject objects or withdraws consent.

---

## Seventh. Amendments to this Notice

The Company reserves the right to amend this Privacy Notice at any time, and will disclose such changes through the Platform.

---

## Eighth. Contact

Questions regarding this Notice may be directed to privacy@fintela.io.
