...
An **Invert (what if)** button reruns the same trial with every position flipped from long to short
...
subtheme, or sub portfolio), and a **Weight** toggle switches between net and gross.
...
**Group by** control lets you split by sector, industry, theme, or subtheme, and a **Filters** panel
