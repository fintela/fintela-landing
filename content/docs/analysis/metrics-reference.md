...
| Label | Whatever display name you gave it when you promoted it: shown exactly as you set it, not autogenerated. |
...
built in options or one of your organization's custom metrics is rejected, as is a stage that isn't one of
