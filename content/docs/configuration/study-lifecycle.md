...
|---|---|---|
| N/A | You save a new study without launching it | Draft |
| N/A | You launch a study immediately when creating it | Draft, then immediately Queued |
| N/A | You duplicate a study | Draft (the copy always starts fresh, no matter the original's status) |
| N/A | You launch directly into a risk manager optimization | Queued (skips Draft entirely) |
