...
| CAGR | Number range | N/A |
| Sharpe | Number range | N/A |
| Max drawdown | Number range | N/A |
| Portfolio Groups | Number range | How many groups the portfolio belongs to |
| Date promoted | Date range | N/A |
...
| [Portfolio Analysis](/docs/portfolio-detail) header | A promote control for that one trial | N/A |
| [Portfolio group](/docs/portfolio-groups) membership | **Implicit**: adding a raw trial straight into a group promotes it automatically first | N/A |
...
> [!WARNING]
> Promotion never reruns a backtest and never re optimizes anything. If a trial's numbers looked wrong before you promoted it, they'll look exactly the same afterward: see [analyzing results](/docs/analyzing-results) if something seems off.
