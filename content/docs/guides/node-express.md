...
rather than being rewritten to fit Fintela's own in app editor. This is the same tradeoff
[External strategies](/docs/external-strategies) and [External fitness](/docs/external-fitness)
...
For the tradeoffs against writing your logic directly inside Fintela's own editor instead, see
