...
Everything else is Fintela's job, not yours: screening the universe, searching the parameter space,
choosing the search strategy, running the simulation, computing the metrics, drawing the charts,
keeping results current day to day, talking to your broker.
