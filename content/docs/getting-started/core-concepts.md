...
| Built-ins | Ready to use as-is — you can't edit, duplicate, or delete them, only pick one |
...
> inherits the natural direction of your fitness function (a custom scorer maximizes; a built-in like
> drawdown, where lower is better, minimizes), but you can also pin a study to maximize or minimize
...
| How you create one | In the [Risk Managers](/docs/risk-managers) registry, for anything custom. Built-ins don't need to be created — you attach them directly |
